...
# Autor: Goz
# Modifica el programa de la Parte 4 agregando lo siguiente:

# Si se piden pizzas mexicana, festiva o campirana grandes se da el 50% de descuento en esas pizza
# Si se piden pizzas festiva, mexicana o campirana gigantes se da el 20% de descuento en esas pizza
# El descuento se debe ver reflejado en la cuenta
...
while main_status:
    ...
    if main_selection == '1':
        ...
        while status:
            ...
            if (client_order[0] == 'Mexicana' or client_order[0] == 'Festiva' or client_order[0] == 'Campirana') and client_order[1] == 'grande':
                client_order[2] = client_order[2]/2
            elif (client_order[0] == 'Mexicana' or client_order[0] == 'Festiva' or client_order[0] == 'Campirana') and client_order[1] == 'gigante':
                client_order[2] = client_order[2] - (client_order[2] * 0.2)
